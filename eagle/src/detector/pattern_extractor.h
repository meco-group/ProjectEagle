...
namespace eagle {
    ...
    class PatternExtractor
    {
        ...
        public:
            ...
            cloud2_t extract(cv::Mat& img, int& id, bool display = false);
            cloud2_t extract(cv::Mat& img, const cv::Point2f& offset, bool display = false);
            ...
            std::vector<cloud2_t> extract(std::vector<cv::Mat>& list, std::vector<int>& id, bool display = false);
            std::vector<cloud2_t> extract(std::vector<cv::Mat>& list, const std::vector<cv::Point2f>& offset, bool display = false);
            ...
            std::vector<cloud2_t> extract(const cv::String& path, std::vector<int>& id, bool display = false);
