...
static void calcBoardCornerPositions(Size boardSize, float squareSize, vector<Point3f>& corners,
                                     CalSettings::Pattern patternType /*= Settings::CHESSBOARD*/);
...
int main(int argc, char* argv[]) {
    ...
    Size imageSize;
    int mode = s.inputType == CalSettings::IMAGE_LIST ? CAPTURING : DETECTION;
...
static bool runCalibration( CalSettings& s, Size& imageSize, Mat& cameraMatrix, Mat& distCoeffs,
